...
def feishu_channel(
    ...
    from ai_personal_assistant.app.channels.feishu.channel import FeishuChannel
...
class TestFeishuChannelFromConfig:
    ...
    def test_from_config_uses_config_values(self, mock_process_handler):
        ...
        from ai_personal_assistant.app.channels.feishu.channel import FeishuChannel
        from ai_personal_assistant.config.config import FeishuConfig
...
class TestFeishuChannelMessageDeduplication:
    ...
    def test_message_id_tracked(self, feishu_channel):
        ...
        from ai_personal_assistant.app.channels.feishu.constants import (
...
class TestFeishuChannelFileUpload:
    ...
    async def test_upload_file_rejects_too_large(
        ...
        from ai_personal_assistant.app.channels.feishu.constants import FEISHU_FILE_MAX_BYTES
...
class TestFeishuChannelDownloadImageResource:
    ...
    def mock_get_message_resource_request(self):
        ...
        with patch(
            "ai_personal_assistant.app.channels.feishu.channel.GetMessageResourceRequest",
        ) as mock_class:
...
class TestFeishuChannelUploadImage:
    ...
    def mock_create_image_request(self):
        ...
        with patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateImageRequestBody",
        ) as mock_body_class, patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateImageRequest",
...
class TestFeishuChannelUploadFile:
    ...
    def mock_create_file_request(self):
        ...
        with patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateFileRequestBody",
        ) as mock_body_class, patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateFileRequest",
        ) as mock_request_class:
            mock_body_class.builder.return_value = mock_body_builder
            mock_request_class.builder.return_value = mock_request_builder
            yield mock_request_class, mock_request
...
class TestFeishuChannelSendMessage:
    ...
    def mock_create_message_request(self):
        ...
        with patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateMessageRequestBody",
        ) as mock_body_class, patch(
            "ai_personal_assistant.app.channels.feishu.channel.CreateMessageRequest",
        ) as mock_request_class:
            mock_body_class.builder.return_value = mock_body_builder
            mock_request_class.builder.return_value = mock_request_builder
            yield mock_request_class, mock_request
