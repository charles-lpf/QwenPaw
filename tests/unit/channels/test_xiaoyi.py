...
def xiaoyi_channel(mock_process, tmp_path):
    ...
    from ai_personal_assistant.app.channels.xiaoyi.channel import XiaoYiChannel
...
class TestXiaoYiChannelWebSocketConnection:
    ...
    async def test_connect_establishes_websocket(
        ...
        with patch(
            "ai_personal_assistant.app.channels.xiaoyi.channel.generate_auth_headers",
...
class TestXiaoYiChannelConnectionRegistry:
    ...
    async def test_unregister_connection_removes_from_registry(
        ...
        from ai_personal_assistant.app.channels.xiaoyi import channel as xiaoyi_module
