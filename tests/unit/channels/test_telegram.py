...
class TestTelegramChannelFromConfig:
    ...
    def test_from_config_with_config_object(
        ...
        from ai_personal_assistant.app.channels.telegram.channel import TelegramChannel
        from ai_personal_assistant.config.config import TelegramConfig
...
class TestTelegramSendMediaValue:
    ...
    async def test_send_media_value_file_not_found(
        ...
        from ai_personal_assistant.app.channels.telegram.channel import (
...
class TestTelegramMessageMeta:
    ...
    def test_message_meta_full(self):
        ...
        from ai_personal_assistant.app.channels.telegram.channel import _message_meta
...
class TestTelegramExceptions:
    ...
    def test_file_too_large_error(self):
        ...
        from ai_personal_assistant.app.channels.telegram.channel import _FileTooLargeError
