...
def voice_channel(mock_process):
    ...
    from ai_personal_assistant.app.channels.voice.channel import VoiceChannel
...
class TestVoiceChannelLifecycle:
    ...
    async def test_start_success(
        ...
        with patch(
            "ai_personal_assistant.tunnel.CloudflareTunnelDriver",
            return_value=mock_tunnel_manager,
        ):
            with patch(
                "ai_personal_assistant.config.utils.read_last_api",
