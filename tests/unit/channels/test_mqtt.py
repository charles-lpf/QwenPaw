...
def mqtt_channel(mock_process):
    ...
    from ai_personal_assistant.app.channels.mqtt.channel import MQTTChannel
...
class TestMQTTChannelLifecycle:
    ...
    async def test_start_success(self, mqtt_channel, mock_mqtt_client):
        ...
        with patch(
            "ai_personal_assistant.app.channels.mqtt.channel.mqtt.Client",
...
class TestMQTTChannelSend:
    ...
    async def test_send_media_audio(self, mqtt_channel, mock_mqtt_client):
        ...
        from ai_personal_assistant.app.channels.base import AudioContent, ContentType
