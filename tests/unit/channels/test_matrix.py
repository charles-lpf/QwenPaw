...
from ai_personal_assistant.app.channels.matrix.channel import MatrixChannel
from ai_personal_assistant.config.config import MatrixConfig
...
class TestMatrixChannelStartStop:
    ...
    async def test_start_creates_client(
        ...
        with patch(
            "ai_personal_assistant.app.channels.matrix.channel.PersonalAssistantMatrixClient",
