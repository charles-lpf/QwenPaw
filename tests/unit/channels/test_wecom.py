...
def wecom_channel(
    ...
    from ai_personal_assistant.app.channels.wecom.channel import WecomChannel
...
class TestWecomChannelDeduplication:
    ...
    def test_processed_ids_limit(self, wecom_channel):
        ...
        from ai_personal_assistant.app.channels.wecom.channel import _WECOM_PROCESSED_IDS_MAX
