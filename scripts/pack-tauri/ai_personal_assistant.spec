...
"""
PyInstaller spec file for AI Personal Assistant Desktop (Tauri sidecar).
...
SRC = REPO_ROOT / "src" / "ai_personal_assistant"
...
# from ai_personal_assistant/console, so Tauri can navigate to the backend-hosted same-origin
...
_data_dirs = [
    ("agents/skills", "ai_personal_assistant/agents/skills"),
    ("agents/md_files", "ai_personal_assistant/agents/md_files"),
    ("tokenizer", "ai_personal_assistant/tokenizer"),
    ("security/tool_guard/rules", "ai_personal_assistant/security/tool_guard/rules"),
    ("security/skill_scanner/rules", "ai_personal_assistant/security/skill_scanner/rules"),
    ("security/skill_scanner/data", "ai_personal_assistant/security/skill_scanner/data"),
]
datas = [
    (str(SRC / src), dst) for src, dst in _data_dirs if (SRC / src).is_dir()
]
datas += collect_tree(CONSOLE_DIST, "ai_personal_assistant/console")
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        *collect_submodules("ai_personal_assistant.cli"),
        # All channel adapters (imported on-demand at runtime)
        *collect_submodules("ai_personal_assistant.app.channels"),
        # ASGI app entry points
        "ai_personal_assistant.app._app",
        "ai_personal_assistant.app.api",
        "ai_personal_assistant.app.middleware",
        "ai_personal_assistant.app.multi_agent_manager",
        "ai_personal_assistant.app.runner",
        # Backup modules are exposed through ai_personal_assistant.backup.__getattr__, which
        # PyInstaller cannot discover from static imports.
        *collect_submodules("ai_personal_assistant.backup"),
