...
$ConsoleDest = Join-Path $RepoRoot "src\ai_personal_assistant\console"
...
Write-Host "[wheel_build] Copying console/dist/* -> src/ai_personal_assistant/console/..."
...
$DocsDest = Join-Path $RepoRoot "src\ai_personal_assistant\docs"
