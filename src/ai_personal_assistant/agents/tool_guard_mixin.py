# -*- coding: utf-8 -*-
"""Tool-guard mixin for PersonalAssistantAgent.
...
if TYPE_CHECKING:
    from ai_personal_assistant.app.approvals import PendingApproval
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from ai_personal_assistant.security.tool_guard.engine import get_guard_engine
        from ai_personal_assistant.app.approvals import get_approval_service
    ...
    async def _decide_guard_action(
        ...
        from ai_personal_assistant.security.tool_guard.utils import log_findings
    ...
    async def _acting_auto_denied(
        ...
        from ai_personal_assistant.security.tool_guard.approval import (
