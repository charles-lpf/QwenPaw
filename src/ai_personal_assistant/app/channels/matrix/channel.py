...
logger = logging.getLogger("ai_personal_assistant.channels.matrix")
...
class PersonalAssistantMatrixClient(AsyncClient):
...
class MatrixChannel(BaseChannel):
    ...
    def _init_async_client(self, resolved_device_id: str) -> None:
        ...
        self._client = PersonalAssistantMatrixClient(
            self.homeserver,
