...
class PluginLoader:
    ...
    async def unload_plugin(
        ...
        removes the plugin's tools from ``ai_personal_assistant.agents.tools``.
    ...
    def _cleanup_plugin_tools(
        ...
        """Remove plugin tools from ``ai_personal_assistant.agents.tools``.
        ...
        """
        try:
            tools_module = sys.modules.get("ai_personal_assistant.agents.tools")
