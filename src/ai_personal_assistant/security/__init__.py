...
* **Tool-call guarding** (``ai_personal_assistant.security.tool_guard``)
  Pre-execution parameter scanning to detect dangerous tool usage
  patterns (command injection, data exfiltration, etc.).
* **Skill scanning** (``ai_personal_assistant.security.skill_scanner``)
  Static analysis of skill directories before install / activation.
* **Secret storage** (``ai_personal_assistant.security.secret_store``)
