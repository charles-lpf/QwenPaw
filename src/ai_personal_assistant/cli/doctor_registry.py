...
Plugins can expose a setuptools entry point in group ``ai_personal_assistant.doctor``::

    [project.entry-points."ai_personal_assistant.doctor"]
...
def _load_entry_point_functions() -> list[tuple[str, DoctorNotesFn]]:
    ...
    seen: set[str] = set()
    for group in ("ai_personal_assistant.doctor", "copaw.doctor"):
