...
# Log file opened on app startup (see ``ai_personal_assistant.app._app`` lifespan).
...
def check_enabled_agents_load_agent_config(cfg: Config) -> tuple[bool, str]:
    """Dry-run :func:`~ai_personal_assistant.config.config.load_agent_config` for enabled.
