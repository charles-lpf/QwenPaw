...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("ai_personal_assistant.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("ai_personal_assistant.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "ai_personal_assistant.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("ai_personal_assistant.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("ai_personal_assistant.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("ai_personal_assistant.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("ai_personal_assistant.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("ai_personal_assistant.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("ai_personal_assistant.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("ai_personal_assistant.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "ai_personal_assistant.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("ai_personal_assistant.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "ai_personal_assistant.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("ai_personal_assistant.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("ai_personal_assistant.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "ai_personal_assistant.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("ai_personal_assistant.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("ai_personal_assistant.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("ai_personal_assistant.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "ai_personal_assistant.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("ai_personal_assistant.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("ai_personal_assistant.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
    },
)
